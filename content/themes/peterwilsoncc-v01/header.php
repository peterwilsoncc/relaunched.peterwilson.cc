		...
		<div class="Page_Header">
			<header class="Header" role="banner">
				<div class="Header_Logo">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0" y="0" viewBox="0 0 160 160" enable-background="new 0 0 160 160" xml:space="preserve" class="Logo">
...
<polygon class="Logo_fill" points="41.5,97.8 23.6,97.8 23.6,117.7"/>
				...
				<div class="Header_NonLogo">
					...
					<div class="Header_Bio">
						<!-- faux widget -->
						<p>Peter Wilson has been making websites since around 1995. A front-end developer with a love for CSS, Peter has worked on sites for some of the country's largest and smallest companies.</p>
					</div>
				</div>
			</header>
		</div>
