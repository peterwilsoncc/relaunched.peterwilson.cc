...
The [Jetpack](http://wordpress.org/extend/plugins/jetpack/) plugin by Automattic does something sneaky: it auto-activates new Jetpack modules. Instead of allowing you to opt in to new modules, Jetpack cheerfully activates them without your permission. These modules can change how your site works and looks.
...
2. Activate the "Manual Control for Jetpack" plugin in your WordPress administration interface
...
I can't gurantee it. If they change how Jetpack module auto-activation and error handling works, it could break.
